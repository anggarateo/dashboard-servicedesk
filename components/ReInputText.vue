...
const inputTextKindClass = () => {
  return {
    'mt-1': props.label,
    'bg-white w-full py-3 px-4 border border-gray-300 rounded-xl placeholder-gray-400 ': props.type === 'number' || props.type === 'text' || props.type === 'email' || props.type === 'password',
    'focus:ring focus:ring-opacity-90 focus:ring-offset-2 focus:ring-offset-white focus:ring-primary':  props.type === 'number' ||(props.type === 'text' || props.type === 'email' || props.type === 'password') && !props.disabled && !props.error,
...
const styleInputText = () => {
  ...
  return {
    def,
    'line-height: 1.5;': props.type === 'number' || props.type === 'text' || props.type === 'email' || props.type === 'password',
